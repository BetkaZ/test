...
public class AvastTestEn {
	...
	@Test
	public void testAvastEn() {
		driver.get("https://www.avast.com/en-us/lp-business-aff-secureline-45");
		...
		String cartPrice = driver.findElement(By.className("av_lineItem-listPrice")).getText();
